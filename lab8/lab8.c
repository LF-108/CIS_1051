...
int main()
{
    ...
    program_identification(8, "UPC Scan", "Validates a given UPC barcode and tells you what kind of products in corresponds to."); 
 ...
 *Postconditions: barcode_array[12] filled with 12 converted integer elements 
 *Globals: NONE
