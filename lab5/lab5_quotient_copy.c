...
void quotientAndRemainder(int *quotient, int *remainder);
...
int main()
{
	...
	int quotient;  //Declares int quotient, which stores the value of the quotient of quotientAndRemainder
 	...
 	quotientAndRemainder(&quotient, &remainder); //Calls function quotientAndRemainder()
 ...
 */
{
        int numerator;   //Declares int numerator, which will store user's input for numerator
        int denominator; //Declares int denominator, which will store user's input for denominator
