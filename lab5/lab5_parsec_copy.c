...
int main()
{
	...
	program_identification(5, "Drivers(Parsec)", "Converts a given number of parsecs to light years.");
        ...
        parsecToLightYear(numberin);//Calls parsecToLightYear
 ...
 */
{
    double light_years;//Declares double light years, which will store the number of lgiht years
    ...
    printf("%lf parsecs is %lf lightyears.\n", numberin, light_years); //Prints the number of lightyears in the given parsec value
