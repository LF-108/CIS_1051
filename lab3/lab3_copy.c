...

{
  ...
  int gos_step1; //Declares an int that stores step 1 of Gosper's algorithm
  ...
  gos_step3 = (2*x + 1.0/3.0)*PI;
  
  gos_step4 = sqrt(gos_step3);
  
  gos_solution = gos_step1*gos_step2*gos_step4;
